...
/**
 * Mettre en place un compte a rebours (par ex utile lorsque on fait exploser
 * une voiture, pour afficher l'image d'expl.)
 * 
 * @param delay
 */
...
/**
 * Si la voiture touche la ligne d'arrivée
 * 
 * @return
 */
