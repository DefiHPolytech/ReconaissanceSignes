...
public class PanneauVideo extends JPanel implements KeyListener {
    ...
    public void paintComponent(Graphics g) {
        ...
        if (this.rectVisage != null) {
            tracerEllipse(new CvRect(rectVisage.x(), rectVisage.y(),
                    rectVisage.width(), rectVisage.height()));
        }
    ...
    public IplImage getImageIpl() {
        return this.thFlux.getCaptureIpl();
    }
    ...
    public void setRectangleMain(CvRect rectangle) {
        ...
        this.rectMain.y(rectangle.y());
        this.rectMain.width(rectangle.width());
        this.rectMain.height(rectangle.height());
    }
    ...
    public CvRect getRectMain() {
        return this.rectMain;
    }

    private void tracerEllipse(CvRect rect) {
        // on reduit la largeur de l'ellipse
        this.rectVisage.x(this.rectVisage.x() + (this.rectVisage.width() * 10)
                / 100);
        this.rectVisage.width(this.rectVisage.width()
                - (this.rectVisage.width() * 20) / 100);

        // on reduit la hauteur de l'ellipse
        this.rectVisage.y(this.rectVisage.y() + (this.rectVisage.height() * 5)
                / 100);
        this.rectVisage.height(this.rectVisage.height()
                - (this.rectVisage.height() * 10) / 100);
    ...
    public void keyReleased(KeyEvent e) {
        ...
        case 61: // touche +
            if (rectMain.width() + 10 < this.image.getWidth()
                    && rectMain.height() + 10 < this.image.getHeight()) {
