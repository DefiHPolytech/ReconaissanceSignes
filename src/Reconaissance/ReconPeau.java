...
public class ReconPeau {
  ...
  private static final int INTERVALE_SV = 50;
   ...
   //on detecte la couleur de la peau et on cree une image noir et blanc
    ...
    public static int getMoyenneH () { 
    	return (hueLowerR + hueUpperR)/2 ;
    }
    public static int getMoyenneS () {
    	return (sLower + sUpper)/2 ;
    }
    public static int getMoyenneV () {
    	return (vLower + vUpper)/2 ;
    }
